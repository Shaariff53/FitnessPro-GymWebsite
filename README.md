...
Informational Sections – Includes About Us and Contact Us pages for easy navigation and user trust.

BMI Calculator – An interactive tool where users can input their height and weight to instantly calculate their BMI.
...
Learned to combine design, interactivity, and logic in a single project.

Gained experience in building a website with real-world use cases in min
